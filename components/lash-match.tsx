...
import { Camera, Check, Mail, Phone, X } from "lucide-react"
            ...
            <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-6">
              ...
              <div>
                ...
                <button
                  ...
                  className="flex w-full flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-border bg-secondary/50 px-6 py-8 text-center transition-colors hover:border-accent hover:bg-secondary"
                >
                  {previewUrl ? (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-input bg-background px-4 py-3 text-foreground outline-none transition-colors placeholder:text-muted-foreground/60 focus:border-accent focus:ring-2 focus:ring-accent/30"
                />
              </div>
              ...
              <button
                type="submit"
                className="mt-1 w-full rounded-full bg-primary px-8 py-4 text-sm font-semibold uppercase tracking-[0.15em] text-primary-foreground transition-transform hover:scale-[1.02] active:scale-100"
              >
